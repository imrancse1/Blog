...
@push('css')
    ...
    <style>
        .header-bg{
            height: 400px;
            width: 100%;
            background-image: url({{ url('post/'.$post->image) }});
                    ...
                    <div class="main-post">
                        ...
                        <div class="blog-post-inner">
                            ...
                            <div class="post-info">
                                ...
                                <div class="left-area">
                                    <a class="avatar" href="#"><img src="{{ url('profile/'.$post->user->image) }}" alt="Profile Image"></a>
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{ url('post/'.$randompost->image) }}" style="height: 50px " alt="{{ $randompost->title }}"></div>

                                <a class="avatar" href="#"><img src="{{ url('profile/'.$randompost->user->image) }}" alt="Profile Image"></a>
