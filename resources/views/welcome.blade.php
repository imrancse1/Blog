               ...
               @forelse($categories as $category)
                    <div class="swiper-slide">
                        ...
                        <a class="slider-category" href="{{ route('category.posts',$category->slug) }}">
                            <div class="blog-image"><img src="{{ url('category/'.$category->image) }}" alt="{{ $category->name }}"></div>
...
{{--                                <div class="blog-image"><img src="{{ Storage::disk('public')->url('post/'.$post->image) }}" alt="{{ $post->title }}"></div>--}}
                                ...
                                <a class="avatar" href="{{ route('author.profile',$post->user->username) }}"><img src="{{ url('profile/'.$post->user->image) }}" alt="Profile Image"></a>
